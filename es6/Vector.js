import u  from './utils/underscore';
...
extend(Vector.prototype, EventsDecorator)
...
var xgs = {
  ...
  set: function(v) {
    this._x = v;
    this.trigger(EventTypes.change, 'x');
  }
};
...
var ygs = {
  ...
  set: function(v) {
    this._y = v;
    this.trigger(EventTypes.change, 'y');
  }
};
...
Vector.prototype.bind = Vector.prototype.on = function() {
  ...
  if (!this._bound) {
    ...
    u.extend(this, BoundProto);
    this._bound = true; // Reserved for event initialization check
  }

  EventsDecorator.bind.apply(this, arguments);
