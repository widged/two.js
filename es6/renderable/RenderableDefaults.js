...
/*
center -- A `Vector2` that represents the position of the x, y coordinates at the center of the gradient.
radius -- A number representing the radius of the radialGradient.
focal -- A `Vector2` that represents the position of the x, y coordinates as the focal point for the gradient's trajectory.
...
/**
left -- A `Vector2` that represents the position of the x, y coordinates to the “left” of the gradient's two end points.
right -- A `Vector2` that represents the position of the x, y coordinates to the “right” of the gradient's two end points.
spread -- Defines how the gradient is rendered by the renderer. For more details see the w3c svg spec.
stops -- A list of `Stop` objects that is two-way databound. Individual stops may be manipulated.
*/
FN.LinearGradient = {
