...
import UtilsThis from './utils-this';
import is from './is';
...
var Utils = _.extend(_, UtilsThis,{
      ...
      getCurveFromPoints: function(points, closed) {
        ...
        for (var i = 0; i < l; i++) {
          ...
          b.controls.left.x = is.Number(b.controls.left.x) ? b.controls.left.x : b.x;
          b.controls.left.y = is.Number(b.controls.left.y) ? b.controls.left.y : b.y;

          b.controls.right.x = is.Number(b.controls.right.x) ? b.controls.right.x : b.x;
          b.controls.right.y = is.Number(b.controls.right.y) ? b.controls.right.y : b.y;
      ...
      getControlPoints: function(a, b, c) {
        ...
        b.u = is.Object(b.controls.left) ? b.controls.left : new Vector(0, 0);
        b.v = is.Object(b.controls.right) ? b.controls.right : new Vector(0, 0);
