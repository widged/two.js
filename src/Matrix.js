...
var Matrix = function Matrix(a, b, c, d, e, f) {
  ...
  this.elements = new _utilArray2['default'](9);

  var elements = a;
  if (!_utilUtils2['default'].isArray(elements)) {
    elements = _utilUtils2['default'].toArray(arguments);
  }
...
_utilUtils2['default'].extend(Matrix, {
...
_utilUtils2['default'].extend(Matrix.prototype, _utilEventsDecoratorJs2['default'], {
  ...
  set: function set(a) {
    ...
    _utilUtils2['default'].extend(this.elements, elements);
  ...
  multiply: function multiply(a, b, c, d, e, f, g, h, i) {
    ...
    if (l <= 1) {
      ...
      _utilUtils2['default'].each(this.elements, function (v, i) {
        this.elements[i] = v * a;
      }, this);
