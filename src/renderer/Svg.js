...
var svg = {
  ...
  createElement: function createElement(name, attrs) {
    ...
    if (tag === 'svg') {
      attrs = _utilUtils2['default'].defaults(attrs || {}, {
        version: this.version
      });
    }
    if (!_utilUtils2['default'].isEmpty(attrs)) {
  ...
  toString: function toString(points, closed) {
    ...
    var l = points.length,
        last = l - 1,
        d,
        // The elusive last Commands.move point
    ret = '';
    ...
    for (var i = 0; i < l; i++) {
      ...
      switch (b._command) {
        ...
        case _constantCommandTypes2['default'].close:
          command = _constantCommandTypes2['default'].close;
          break;
        ...
        case _constantCommandTypes2['default'].curve:
          ...
          command = (i === 0 ? _constantCommandTypes2['default'].move : _constantCommandTypes2['default'].curve) + ' ' + vx + ' ' + vy + ' ' + ux + ' ' + uy + ' ' + x + ' ' + y;
          break;

        case _constantCommandTypes2['default'].move:
          d = b;
          command = _constantCommandTypes2['default'].move + ' ' + x + ' ' + y;
          break;
      ...
      if (i >= last && closed) {
        ...
        if (b._command === _constantCommandTypes2['default'].curve) {
