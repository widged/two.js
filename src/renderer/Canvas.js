 ...
 * Constants
 */
var mod = _utilUtils2['default'].mod,
    toFixed = _utilUtils2['default'].toFixed;
var getRatio = _utilUtils2['default'].getRatio;
...
var canvas = {
  ...
  path: {
    ...
    render: function render(ctx, forced, parentClipped) {
      ...
      var matrix, stroke, linewidth, fill, opacity, visible, cap, join, miter, closed, commands, length, last, next, prev, a, b, c, d, ux, uy, vx, vy, ar, bl, br, cl, x, y, mask, clip, defaultMatrix;
...
var Renderer = function Renderer(params) {
  ...
  if (!_utilUtils2['default'].isUndefined(this.ctx.imageSmoothingEnabled)) {
